...
{
	pr_debug(" SOFTING  PHY %d", __LINE__);
...
int phy_restart_aneg(struct phy_device *phydev)
{
	...
	pr_debug(" SOFTING  PHY %d %d", __LINE__, ret);
	return ret;
}
 ...
 */
void phy_queue_state_machine(struct phy_device *phydev,
...
int phy_start_aneg(struct phy_device *phydev)
{
	...
	pr_debug(" SOFTING  PHY %d %d", __LINE__, err);
	return err;
}
...
static irqreturn_t phy_interrupt(int irq, void *phy_dat)
{
	 ...
	 */
	if (IS_ENABLED(CONFIG_PM_SLEEP) && phydev->suspended) {
